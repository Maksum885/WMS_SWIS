...
@section('content')
    <div class="report-panel report-panel-in">
        <div class="report-panel-header">
            <div>
                <div class="report-panel-title">Add Supplier</div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('inbound.suppliers.store') }}">
            @csrf
            <div class="form-grid">
            ...
            <div class="form-actions">
                <button type="submit" class="btn-primary-in">Save Supplier</button>
